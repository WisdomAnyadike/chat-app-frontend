      ...
      <section className="home ">
        <div className="description pt-3">
          ...
          <p className="paragraph">
            In a world filled with opportunities, starting or building a creative solution can make all the
            difference. Explore why people turn to this invaluable resource to
            unlock their potential.
          </p>
          <form id="form" autoComplete="off">
         
            <button type="submit" onClick={signUp} className="btn d-flex align-items-center" aria-label="submit">
              <span>Subscribe</span>
        ...
        <div className="users-color-container pt-3">
