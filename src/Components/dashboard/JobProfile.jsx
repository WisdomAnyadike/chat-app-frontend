            ...
            <div className="main">
                <form onSubmit={formik.handleSubmit} className="container">
                    ...
                    <textarea
                        ...
                        style={{ height: '200px', width: '90%', borderRadius: '15px', padding: "10px" }}
                        id="coverLetter"
                        name="coverLetter"
                    />
                    <small className='app-content-smallText'>
                    ...
                    <div className="exp-cvc">
                        <div className="expiration">
                            <label className='app-content-plainText' htmlFor="portfolioUrl"> Portfolio URL </label>
                            <input
                                onBlur={formik.handleBlur}
                                onChange={formik.handleChange}
                        ...
                        <div className="security">
                            <label className='app-content-plainText' htmlFor="cvUrl"> Upload CV</label>
                            <input
                                accept=".pdf"
                                type="file"
                    ...
                    <div className='btn'>
                        ...
                        <button type="submit" style={{ height: '40px', width: "120px" }} disabled={loading} className="app-content-headerButton">
                            {loading ? (
