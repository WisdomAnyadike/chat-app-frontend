...
import '/src/Components/dashboard/inbox.scss'
...
const DashboardInbox = () => {
    ...
    const profileRole = useSelector(state => state.firstProfileSlice.profileObj.roleName)
            ...
            <div class="app-contain">
                ...
                <div class="app-right">
                    <div class="app-profile-box">
                        ...
                        <p class="app-profile-box-title w-100 d-flex justify-content-center">{profileRole}</p>
