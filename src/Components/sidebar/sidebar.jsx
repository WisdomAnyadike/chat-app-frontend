        ...
        <div class="sidebar">
            <div class="sidebar-header">
                <div class="app-icon">
                    ...
                    {/* <img width={80} height={25} src="/src/assets/download__4_-removebg-preview.png" className='ms-2 mt-1' alt="" /> */}
                </div>
            </div>
            ...
            <div class="account-info">
                <div class="account-info-picture">
                    <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" alt="Account" />
                </div>
                <div class="account-info-name">{userObj.name}</div>


                <button type='button' data-bs-toggle="dropdown" aria-expanded="false" class="account-info-more btn btn-light dropdown-toggle-split " style={{ backgroundColor: 'transparent', border: "none" }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#a8a3cb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal"><circle cx="12" cy="12" r="1" /><circle cx="19" cy="12" r="1" /><circle cx="5" cy="12" r="1" /></svg>

                </button>
                <ul class="dropdown-menu" style={{ backgroundColor: 'transparent', border: 'none' }}>
                    <li onClick={handleLogOut}><b class="dropdown-item bg-light rounded border border-dark" href="#"> <IoLogOut className="me-2" color='#101827' /> Log out </b> </li>
                </ul>
