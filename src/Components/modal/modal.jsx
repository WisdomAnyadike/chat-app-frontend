...
import { setProfileRole } from '../Redux/FirstProfileSlice'
...
const Modal = ({ modal, role, closeModal }) => {
    ...
    return (
        <div class={`modal ${openModal ? 'd-flex' : ''}`}>
            <article class="modal-container">
                ...
                <footer class="modal-container-footer">
                    <button onClick={() => handleSubmit(false)} class="button is-ghost">Decline</button>
                    <button disabled={loading} onClick={() => handleSubmit(true)} class="button d-flex align-items-center justify-content-center is-primary">{
